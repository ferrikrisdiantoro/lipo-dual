            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid md:grid-cols-2 gap-12">
                    ...
                    <FadeIn delay={0.1}>
                        <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100 h-full hover:shadow-lg transition-shadow duration-300">
                            <div className="flex items-center mb-6">
                                <div className="p-3 bg-purple-100 text-purple-700 rounded-lg mr-4">
                                    <PieChart size={24} />
                                </div>
                                ...
                                {siteContent.businessModel.costStructure.items.map((item, index) => (
                                    <div key={index} className="relative pt-1">
                                        ...
                                        <div className="overflow-hidden h-2 mb-4 text-xs flex rounded bg-purple-200">
                                            <div style={{ width: item.value }} className="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-purple-500"></div>
                                        </div>
                                    </div>
                                ))}
                            </div>
                    ...
                    <FadeIn delay={0.2}>
                        <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100 h-full hover:shadow-lg transition-shadow duration-300">
                            <div className="flex items-center mb-6">
                                <div className="p-3 bg-emerald-100 text-emerald-700 rounded-lg mr-4">
                                    <DollarSign size={24} />
                                </div>
